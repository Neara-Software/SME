...
class LspBridge {
    constructor(sidecarUrl = DEFAULT_SIDECAR_URL) {
        this.ws = null;
        ...
        try {
            ...
            if (this.ws && this.ws.readyState === ws_1.WebSocket.OPEN) {
                ...
                if (message.method !== undefined && message.id !== undefined) {
                    ...
                    const wsRequest = {
                        id: typeof message.id === 'number' ? message.id : parseInt(message.id, 10) || 0,
                        request: {
                            type: 'lsp',
                            payload: message,
                        },
